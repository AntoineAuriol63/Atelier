...
15. Le deuxième site d'une autre nature avant toute nouvelle fonctionnalité. **Fait le 9 septembre 2026, en code puis refait depuis l'éditeur (`docs/audit-usage-restaurant.md`, onze points relevés, à traiter avant toute nouvelle fonctionnalité)** : « Maison Aurèle », restaurant (carte et événements en bases, page par événement, réservation, composants avec propriétés et variantes, apparitions, questions dépliables, ancres, redirections, 404), gabarit à la création. A demandé la première tranche des interactions déclaratives (D31), qui manquaient au modèle rendu.
