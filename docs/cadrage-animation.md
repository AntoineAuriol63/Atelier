...
*Révision du 23 septembre 2026 (D60) : l'animation n'est plus un quatrième mode. C'est un tiroir sous le canevas, ouvert depuis la rubrique Animation d'un élément (« Ouvrir la ligne de temps »), le bouton de la barre du canevas ou la palette ⌘K. Le tiroir a deux colonnes : à gauche les trois étages 1 et la bibliothèque décrits ci-dessous, à droite la ligne de temps (étages 2 et 3) elle-même en deux colonnes, scène et pistes puis réglages. L'inspecteur reste à droite de l'écran ; l'aperçu passe en sélection seule tant qu'une ligne de temps est ouverte. Révision du 24 septembre 2026 : l'outil est recentré sur le geste « je sélectionne un élément, je pose une image-clé, je règle son apparence » ; le tiroir montre la scène de la section (une ligne par élément, une barre par mouvement, les images-clés de l'élément sélectionné, tout se tire), et ni animation nommée, ni piste, ni pioche, ni bibliothèque ne sont plus exposées ; réutiliser une animation de clic ou de survol reste possible (« Comme un autre élément »). Le texte d'origine suit, comme trace du modèle sous-jacent, qui n'a pas changé.*
