...
11. Pas de style partagé **Carte** dans un site vierge ; pas de choix de l'entrée d'aperçu d'un modèle ; titre SEO d'une page modèle = nom de la page (« Événements ») au lieu du titre de l'entrée.
