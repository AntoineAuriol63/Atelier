...
export const restaurantSite: Site = {
    ...
    },
    {
      ...
      root: B("rp_about_root", "Page", "div", {}, [
        ...
        section("ra_story", "Histoire", {}, [container("ra_story_in", { display: "grid", gridTemplateColumns: "1fr 1fr", gap: tok("space.10"), alignItems: "center" }, [
          ...
          reveal(IMG("ra_img", "ras_equipe", "4 / 5", { name: "Photo de l'équipe", style: { base: { borderRadius: tok("radius.lg"), overflow: "hidden" } } }), "slide-left", 100),
        ], { style: { breakpoints: { tablet: { gridTemplateColumns: "1fr" } } } })]),
  ...
  assets: [
    ...
    { id: "ras_equipe", kind: "image", url: "https://picsum.photos/id/312/1200/1500", width: 1200, height: 1500, name: "L'équipe en cuisine" },
    { id: "ras_t1", kind: "image", url: "https://picsum.photos/id/338/1000/1000", width: 1000, height: 1000, name: "Aurèle" },
    { id: "ras_t2", kind: "image", url: "https://picsum.photos/id/342/1000/1000", width: 1000, height: 1000, name: "Nils" },
    { id: "ras_t3", kind: "image", url: "https://picsum.photos/id/349/1000/1000", width: 1000, height: 1000, name: "Inès" },
    { id: "ras_d1", kind: "image", url: "https://picsum.photos/id/365/1200/900", width: 1200, height: 900, name: "Agneau des Combrailles" },
    { id: "ras_d2", kind: "image", url: "https://picsum.photos/id/429/1200/900", width: 1200, height: 900, name: "Truite de Besse" },
    { id: "ras_d3", kind: "image", url: "https://picsum.photos/id/431/1200/900", width: 1200, height: 900, name: "Tarte aux myrtilles" },
    { id: "ras_d4", kind: "image", url: "https://picsum.photos/id/488/1200/900", width: 1200, height: 900, name: "Légumes rôtis" },
    { id: "ras_e1", kind: "image", url: "https://picsum.photos/id/493/1200/750", width: 1200, height: 750, name: "Soirée truffe" },
    { id: "ras_e2", kind: "image", url: "https://picsum.photos/id/674/1200/750", width: 1200, height: 750, name: "Accords vins" },
