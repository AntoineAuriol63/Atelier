...
import type { Entry, Role, Site } from "@atelier/model";
...
export function EditorShellClient({ initialSite, initialVersion, initialEntries, role }: { initialSite: Site; initialVersion: number; initialEntries: Entry[]; role: Role }) {
  return <EditorShell initialSite={initialSite} initialVersion={initialVersion} initialEntries={initialEntries} role={role} />;
}
